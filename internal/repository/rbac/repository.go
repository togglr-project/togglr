...
func NewRoles(pool *pgxpool.Pool) *Roles { //nolint:ireturn // used by DI
...
func NewPermissions(pool *pgxpool.Pool) *Permissions { //nolint:ireturn // used by DI
...
func NewMemberships(pool *pgxpool.Pool) *Memberships { //nolint:ireturn // used by DI
