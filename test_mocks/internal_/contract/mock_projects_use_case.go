...
// GetProjectsByUserID provides a mock function for the type MockProjectsUseCase
func (_mock *MockProjectsUseCase) GetProjectsByUserID(ctx context.Context, userID domain.UserID, isSuperuser bool) ([]domain.Project, error) {
	ret := _mock.Called(ctx, userID, isSuperuser)
	...
	var r0 []domain.Project
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, domain.UserID, bool) ([]domain.Project, error)); ok {
		return returnFunc(ctx, userID, isSuperuser)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, domain.UserID, bool) []domain.Project); ok {
		r0 = returnFunc(ctx, userID, isSuperuser)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]domain.Project)
		}
	...
	if returnFunc, ok := ret.Get(1).(func(context.Context, domain.UserID, bool) error); ok {
		r1 = returnFunc(ctx, userID, isSuperuser)
	} else {
		r1 = ret.Error(1)
	}
	return r0, r1
...
func (_c *MockProjectsUseCase_GetProjectsByUserID_Call) Return(projects []domain.Project, err error) *MockProjectsUseCase_GetProjectsByUserID_Call {
	_c.Call.Return(projects, err)
	return _c
}

func (_c *MockProjectsUseCase_GetProjectsByUserID_Call) RunAndReturn(run func(ctx context.Context, userID domain.UserID, isSuperuser bool) ([]domain.Project, error)) *MockProjectsUseCase_GetProjectsByUserID_Call {
	_c.Call.Return(run)
	return _c
}
