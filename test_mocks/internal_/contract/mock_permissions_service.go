...
// CanViewProject provides a mock function for the type MockPermissionsService
func (_mock *MockPermissionsService) CanViewProject(ctx context.Context, projectID domain.ProjectID) error {
	ret := _mock.Called(ctx, projectID)

	if len(ret) == 0 {
		panic("no return value specified for CanViewProject")
	}
...
// MockPermissionsService_CanViewProject_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CanViewProject'
type MockPermissionsService_CanViewProject_Call struct {
	*mock.Call
}

// CanViewProject is a helper method to define mock.On call
//   - ctx context.Context
//   - projectID domain.ProjectID
func (_e *MockPermissionsService_Expecter) CanViewProject(ctx interface{}, projectID interface{}) *MockPermissionsService_CanViewProject_Call {
	return &MockPermissionsService_CanViewProject_Call{Call: _e.mock.On("CanViewProject", ctx, projectID)}
}

func (_c *MockPermissionsService_CanViewProject_Call) Run(run func(ctx context.Context, projectID domain.ProjectID)) *MockPermissionsService_CanViewProject_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockPermissionsService_CanViewProject_Call) Return(err error) *MockPermissionsService_CanViewProject_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockPermissionsService_CanViewProject_Call) RunAndReturn(run func(ctx context.Context, projectID domain.ProjectID) error) *MockPermissionsService_CanViewProject_Call {
	_c.Call.Return(run)
	return _c
}
